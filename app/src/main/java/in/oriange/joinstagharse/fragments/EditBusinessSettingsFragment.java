...
public class EditBusinessSettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_edit_business_settings, container, false);
    ...
    private void submitData() {
        ...
        LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent("EditBusinessSettingsActivity")
