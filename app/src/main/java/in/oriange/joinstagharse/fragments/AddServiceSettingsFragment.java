...
public class AddServiceSettingsFragment extends Fragment {
    ...
    @BindView(R.id.ib_is_online_service_available)
    ImageButton ibIsOnlineServiceAvailable;
    @BindView(R.id.sw_is_online_service_available)
    LabeledSwitch swIsOnlineServiceAvailable;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_add_service_settings, container, false);
    ...
    private void setDefault() {
        ...
        IntentFilter intentFilter = new IntentFilter("AddServiceSettingFragment");
    ...
    private void setEventHandler() {
        ...
        swIsOnlineServiceAvailable.setOnToggledListener((toggleableView, isOn) -> {
            if (isOn) {
                swIsOnlineServiceAvailable.setColorBorder(getResources().getColor(R.color.LimeGreen));
                swIsOnlineServiceAvailable.setColorOn(getResources().getColor(R.color.LimeGreen));
            } else {
                swIsOnlineServiceAvailable.setColorBorder(getResources().getColor(R.color.colorPrimary));
                swIsOnlineServiceAvailable.setColorOn(getResources().getColor(R.color.colorPrimary));
            }
        });
        ...
        ibIsOnlineServiceAvailable.setOnClickListener(v -> Utilities.showAlertDialogNormal(context, ""));
    }
    ...
    private void submitData() {
        ...
        String isOnlineServiceAvailable = swIsOnlineServiceAvailable.isOn() ? "1" : "0";
        ...
        LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent("AddServiceSettingActivity")
                ...
                .putExtra("isOnlineServiceAvailable", isOnlineServiceAvailable));
