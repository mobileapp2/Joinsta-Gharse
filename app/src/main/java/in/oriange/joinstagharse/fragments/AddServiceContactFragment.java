...
public class AddServiceContactFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_add_service_contact, container, false);
    ...
    private void setDefault() {
        ...
        IntentFilter intentFilter1 = new IntentFilter("AddServiceContactFragment");
        IntentFilter intentFilter2 = new IntentFilter("AddServiceContactFragmentSkip");
    ...
    private void submitData() {
        ...
        LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent("AddServiceContactActivity")
