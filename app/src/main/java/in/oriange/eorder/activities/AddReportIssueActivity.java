...
public class AddReportIssueActivity extends AppCompatActivity {
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent("ReportIssueActivity"));
    ...
    protected void onPause() {
        super.onPause();
        hideSoftKeyboard(AddReportIssueActivity.this);
    }
