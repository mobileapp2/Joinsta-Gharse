...
public class AddBusinessActivity extends AppCompatActivity {
    ...
    private String userId, imageName = "", categoryId = "0", latitude = "", longitude = "";
    ...
    private void setEventListner() {
        ...
        btnSelectAddress.setOnClickListener(v -> startActivityForResult(new Intent(context, PickMapLocationActivity.class), LOCATION_REQUEST));
