...
public class EditVendorActivity extends AppCompatActivity {
    ...
    private void init() {
        context = EditVendorActivity.this;
    ...
    private void setDefault() {
        ...
        edtCode.setText(vendorDetails.getVendor_code());
        edtName.setText(vendorDetails.getName());
        tvCountrycode.setText(vendorDetails.getCountry_code());
        edtMobile.setText(vendorDetails.getMobile());
        edtEmail.setText(vendorDetails.getEmail());
        edtCity.setText(vendorDetails.getCity());
        edtBusinessCode.setText(vendorDetails.getBusiness_code());
        edtBusinessName.setText(vendorDetails.getBusiness_name());

        if (vendorDetails.getIs_prime_vendor().equals("1"))
            cbIsPrimeVendor.setChecked(true);
    }
    ...
    private void submitData() {
        ...
        mainObj.addProperty("type", "updateVendor");
        mainObj.addProperty("id", vendorDetails.getId());
        ...
        if (Utilities.isNetworkAvailable(context))
            new EditVendor().execute(mainObj.toString().replace("\'", Matcher.quoteReplacement("\\\'")));
        else
            Utilities.showMessage(R.string.msgt_nointernetconnection, context, 2);
    }

    private class EditVendor extends AsyncTask<String, Void, String> {
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        tv_title.setText("Vendor details updated successfully");
